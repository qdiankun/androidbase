...
public class MainActivity extends AppCompatActivity {
    ...
    private final String[] items = {"使用ViewPagerTabStrip","使用PagerSlidingTabStrip"};
    private final Class<?>[] classes = {ViewPagerTabStripActivity.class,PagerSlidingTabStripActivity.class};
