...
public class MainActivity extends Activity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case REQUEST_CODE_CAMERA:
			...
			// Log.i("TAG", "before bitmapSize = " + bitmapSize/1024+"KB");
			//
			// Bitmap samplebitmap =
			// BitmapUtils.decodeSampledBitmapFromFilepath(imagePath, 100, 100);
			// int samplebitmapSize = BitmapUtils.getBitmapSize(samplebitmap);
			// Log.i("TAG", "before samplebitmapSize = " +
			// samplebitmapSize/1024+"KB");
			cropImage();
			break;
		case REQUEST_CODE_CROP:// 裁剪后返回
			...
			Bitmap bitmap = BitmapFactory.decodeFile(imagePath);
			int bitmapSize = BitmapUtils.getBitmapSize(bitmap);
			Log.i("TAG", "after bitmapSize = " + bitmapSize / 1024 + "KB");

			Bitmap samplebitmap = BitmapUtils.decodeSampledBitmapFromFilepath(imagePath, 200, 200);
			int samplebitmapSize = BitmapUtils.getBitmapSize(samplebitmap);
